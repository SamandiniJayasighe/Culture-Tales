...
// class GypsyPage extends StatelessWidget {
//   const GypsyPage({Key? key}) : super(key: key);

//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: buildAppBar(context),
//       body: const GypsyBody(),
//     );
//   }
...
// class GypsyBody extends StatelessWidget {
//   const GypsyBody({Key? key}) : super(key: key);
//   @override
//   Widget build(BuildContext context) {
//     return Column(
...
//           child: const Center(
//             child: Text(
//               'The Gypsy community, known for their nomadic lifestyle, contributes to the cultural diversity of Sri Lanka with their distinctive music and dance traditions, reflecting a history deeply intertwined with the island s diverse cultural landscape.',
...
// class GypsyBody extends StatefulWidget {
//   const GypsyBody({Key? key}) : super(key: key);

//   @override
//   _GypsyBodyState createState() => _GypsyBodyState();
// }

// class _GypsyBodyState extends State<GypsyBody> {
...
class _GypsyBodyState extends State<GypsyBody> {
  AudioPlayer player = AudioPlayer();
  List<String> names = [
    "Gypsy_English_Gypsy Song of Unity.mp3",
    "Gypsy_Sinhala_Gypsy Song of Unity.wav",
    "Gypsy_Tamil_Gypsy Song of Unity.wav",
    "Gypsy_English_The Gypsy Compass of Kindness.mp3",
    "Gypsy_Sinhala_The Gypsy Compass of Kindness.wav",
    "Gypsy_Tamil_The Gypsy Compass of Kindness.wav",
    "Gypsy_English_The Melody of Unity.mp3",
    "Gypsy_Sinhala_The Melody of Unity.wav",
    "Gypsy_Tamil_The Melody of Unity.wav"
  ];
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          StoryBox(
            topic: 'Gypsy Song of Unity ',
            description:
                'Reduced Conflicts, Enhanced Well-being, Cultural Enrichment',
            stories: [
          ...
          StoryBox(
            topic: 'The Gypsy Compass of Kindness',
            description:
                'Enhanced Well-being, Cultural Enrichment, Reduced Conflicts',
            stories: [
